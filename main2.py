...
video_path = r"C:\Users\ashwi\OneDrive\Desktop\Demo\demo2.mp4"
...
# Get the video's FPS and calculate initial frame delay
...
while True:
        ...
        if score > 0.3:
            ...
            if detected_text.strip():
                ...
                if text_stability_counter >= stability_threshold:
                    ...
                    # Speak the detected stable text once
                    if tts_counter < 1:
    ...
    # Adjust frame delay to compensate for processing time
